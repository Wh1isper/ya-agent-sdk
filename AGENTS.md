...
- YA Desktop unsigned draft releases are generated automatically from `release/desktop/**` branch pushes as `desktop-v*` GitHub draft releases; humans review artifacts and publish from GitHub.
