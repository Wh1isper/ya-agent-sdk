...
@pytest.mark.asyncio
async def test_openai_responses_pro_preset_omits_mode_for_unsupported_websocket_model() -> None:
    model = WebsocketResponsesModel("gpt-5.5", provider=OpenAIProvider(api_key="test-key"))
