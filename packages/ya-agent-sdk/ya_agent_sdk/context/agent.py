...
# XML tag names for canonical per-request context snapshots.
# Each snapshot remains stable in history for prompt-prefix reuse. Compaction strips
# historical snapshots because the processors inject fresh ones after reduction.
...
class AgentContext(BaseModel):
    ...
    """Stable execution-thread identifier when a provider thread is configured."""
