...
YAAI CLI integrates browser automation capabilities through the Chrome DevTools Protocol (CDP). This enables agents to interact with web pages, capture screenshots, fill forms, and perform complex web automation tasks.
...
class DockerBrowserConfig:
    ...
    container_name_prefix: str = "yaai-browser"
...
yaai browser connect ws://localhost:9222
