...
def test_load_project_tools_config(
    ...
    project_config_dir = temp_project_dir / ".yaai"
...
""")
    ...
    os.environ["YAAI_CODE_THEME"] = "light"
    os.environ["YAAI_CDP_URL"] = "auto"
...
def test_save_project_config(
    ...
    config_file = temp_project_dir / ".yaai" / "tools.toml"
    assert not config_file.exists()
