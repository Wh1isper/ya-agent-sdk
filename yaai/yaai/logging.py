"""Logging configuration for yaai TUI.
...
- Verbose (-v set): Log to file (yaai.log in current directory)

Usage:
    from yaai.logging import configure_tui_logging, LogEvent
    ...
    # With verbose=True, also written to yaai.log
"""
...
TUI_LOGGER_NAME = "yaai"
SDK_LOGGER_NAME = "ya_agent_sdk"

# Log file name
LOG_FILE_NAME = "yaai.log"
...
def configure_tui_logging(
    ...
    Redirects both yaai and ya_agent_sdk loggers to emit
    ...
    Args:
        ...
        verbose: If True, also log to file (yaai.log).
