"""Human-in-the-Loop module for yaai.
...
Example:
    from yaai.hitl import ApprovalManager, ApprovalUI
...
from yaai.hitl.approval import ApprovalManager, ApprovalResult, ApprovalState
from yaai.hitl.ui import ApprovalUI
