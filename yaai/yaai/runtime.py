"""Agent runtime factory for yaai.
...
Example:
    ...
    from yaai.config import ConfigManager
...
from yaai.browser import BrowserManager
from yaai.config import ConfigManager, MCPConfig, SubagentsConfig, YaaiConfig
from yaai.environment import TUIEnvironment
from yaai.logging import get_logger
from yaai.mcp import build_mcp_servers
...
def _load_system_prompt(config: YaaiConfig) -> str:
