...
- Profile seeding, subscription-backed Codex profiles, and approval review policy: read [`references/profiles.md`](references/profiles.md)
...
| Profiles                  | [`references/profiles.md`](references/profiles.md)                                       | You seed profiles, manage AgentProfile configuration, or tune approval review policy                            |
